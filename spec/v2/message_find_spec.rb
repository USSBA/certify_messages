  ...
  RSpec.describe "V2 CertifyMessages", type: :feature do
    ...
    describe 'Getting messages', :vcr do
      context 'when getting messages' do
        ...
        let(:messages) { CertifyMessages::Message.find(conversation_uuid: V2::MessageSpecHelper.mock_conversation_uuid) }
      ...
      context "with the priority_read_receipt_parameter" do
        let(:mock) do
          {
            conversation_uuid: V2::MessageSpecHelper.mock_conversation_uuid,
      ...
      context "when the api is not found", vcr: false do
        let(:bad_message) { CertifyMessages::Message.find(conversation_uuid: V2::MessageSpecHelper.mock_conversation_uuid) }
